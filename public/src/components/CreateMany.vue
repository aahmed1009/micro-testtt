      ...
      <form>
        <div class="mb-4">
          ...
          <input type="text"
            ...
            id="name" placeholder="_id" v-model="product._id" />
        </div>
        <div class="mb-4">
          ...
          <input type="text"
            class="border border-gray-300 rounded-md px-3 py-2 w-full focus:outline-none focus:ring focus:border-blue-500"
            id="HMP_ID" placeholder="HMP_ID" v-model="product.HMP_ID" />
        </div>
        <div class="mb-4">
          ...
          <input type="text"
            class="border border-gray-300 rounded-md px-3 py-2 w-full focus:outline-none focus:ring focus:border-blue-500"
            id="GOLD_ID" placeholder="GOLD_ID" v-model="product.GOLD_ID" />
        </div>
        ...
        <div class="mb-4">
          ...
          <input type="text"
            class="border border-gray-300 rounded-md px-3 py-2 w-full focus:outline-none focus:ring focus:border-blue-500"
            id="Organism_Name" placeholder="Organism_Name" v-model="product.Organism_Name" />
        </div>
        <div class="mb-4">
          ...
          <input type="text"
            class="border border-gray-300 rounded-md px-3 py-2 w-full focus:outline-none focus:ring focus:border-blue-500"
            id="Domain" placeholder="Domain" v-model="product.Domain" />
        </div>
        <div class="mb-4">
          ...
          <input type="text"
            class="border border-gray-300 rounded-md px-3 py-2 w-full focus:outline-none focus:ring focus:border-blue-500"
            id="NCBI_Superkingdom" placeholder="NCBI_Superkingdom" v-model="product.NCBI_Superkingdom" />
        </div>
        <div class="mb-4">
          ...
          <input type="text"
            class="border border-gray-300 rounded-md px-3 py-2 w-full focus:outline-none focus:ring focus:border-blue-500"
            id="HMP_Isolation_Body_Site" placeholder="HMP_Isolation_Body_Site"
            v-model="product.HMP_Isolation_Body_Site" />
        </div>
        <div class="mb-4">
          <button @click.prevent="addProduct" v-if="!showBtn"
            class="bg-blue-500 text-white font-bold py-2 px-4 rounded-md hover:bg-blue-700">
            Add
          </button>
          <button v-else @click.prevent="showBtn = !showBtn"
            class="border bg-blue-500 text-white font-bold hover:bg-blue-700 border-gray-300 rounded-md px-3 py-2">
            add more
          </button>
          <button @click.prevent="addForm"
            class="border border-gray-300 rounded-md px-3 py-2 g-blue-500 text-white font-bold hover:bg-teal-700 bg-teal-500">
            Finish
          </button>
